...
%>
            ...
            <input type="text" placeholder="Enter Username" name="name" required style="font-family:verdana;">
            <label>Password : </label> 
            <input type="password" placeholder="Enter Password" name="password" required>
            <button type="submit">Login</button> <br>
            
            <br>
           <center> <a  style="font-family:verdana;font-size:70;text-align:center;" href="createaccount" >Create Account</a> </center>
